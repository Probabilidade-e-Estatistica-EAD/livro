...
# Inferência para dados numéricos {#ch5_inf_num}
...
## Uma média amostral com a distribuição-$t$
...
### Condições para usar a distribuição-t para inferência de uma média
...
### Uma amostra t - Intervalos de Confiança
...
require(knitr)
knitr::include_graphics('rissosDolphin.jpg')
```
...
### Inferência para dados pareados
...
### Testes de hipóteses baseados em uma diferença de médias
...
### Estudo de caso: duas versões de um exame
...
### Resumo da inferência usando a distribuição-$t$ 
...
### Examinando a fórmula do erro padrão (tópico especial)
...
### Estimativa de desvio padrão agrupada (tópico especial)
...
## Cálculos de potência para uma diferença de médias (tópico especial)
...
### Passando pelas propostas de um teste 
