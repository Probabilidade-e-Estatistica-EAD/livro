...
# Distribuições de Variáveis Aleatórias {#ch3_distribuicoes}

## Distribuição Normal {#normalDist}

```{r, include=FALSE}
knitr::opts_chunk$set(warning = FALSE, message = FALSE, echo = TRUE, cache = TRUE, 
                      fig.align = "center", out.width='100%', out.height='30%', fig.height=3)
...
### Exemplos de probabilidade normal
...
## Avaliando a aproximação normal
...
```{r histn, fig.cap = "Histogramas simulados para dados normalmente distribuídos conforme o tamanho da amostra aumenta", fig.height=5, out.height='50%'}
library(gganimate)
set.seed(1)
...
## Distribuição geométrica (tópico especial)
...
## Distribuição binomial (tópico especial)
...
### A aproximação normal se divide em pequenos intervalos
...
## Distribuições mais discretas (tópico especial)
